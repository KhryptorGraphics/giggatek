 ...
 * Data Models Loader
 * 
 * This script loads the data models in the browser.
 */

// Create global dataModels object
window.dataModels = {
  /**
   ...
   */
  normalizeRental: function(rental) {
   ...
   */
  prepareOrderData: function(orderData) {
    const prepared = {
   ...
   */
  prepareRentalData: function(rentalData) {
    const prepared = {
